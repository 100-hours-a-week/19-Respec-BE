...
import kakaotech.bootcamp.respec.specranking.domain.spec.main.spec.dto.request.PostSpecRequest.EducationDetail;
...
import kakaotech.bootcamp.respec.specranking.global.infrastructure.ai.dto.ai.mapping.AiDtoMapping;
        ...
        if (isNotEmpty(request.finalEducation())) {
            ...
            if (isNotEmpty(request.educationDetails())) {
                for (EducationDetail educationDetailDto : request.educationDetails()) {
                    ...
                    kakaotech.bootcamp.respec.specranking.domain.spec.sub.educationdetail.entity.EducationDetail educationDetail = new kakaotech.bootcamp.respec.specranking.domain.spec.sub.educationdetail.entity.EducationDetail(
                            savedEducation,
